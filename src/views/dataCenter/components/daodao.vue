<template>
    <div class="contents" v-if="isLoading == false">
        <div class="content_r">
            <div class="con_left">
                <!-- 当日业绩 -->
                <daodaoPerforamance :time="time" ref="daodaos" :performance="performance.currentDateDataVo"  :isLoading="isLoading" title="当日业绩"/>
            </div>
            <div class="con_right">
                <!-- 总业绩 -->
                <daodaoPerforamance :time="time" ref="daodaos" :performance="performance.monthDataVo"  :isLoading="isLoading" title="总业绩"/>
            </div>
        </div>
...
<script>
import daodaoPerforamance from "./daodaoPerforamance.vue"
export default {
    components:{
        daodaoPerforamance
    },
