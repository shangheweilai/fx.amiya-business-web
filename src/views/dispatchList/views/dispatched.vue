    ...
    <div class="list_wrap" >
      ...
      >
        ...
        <van-swipe-cell v-for="(item, index) in list" :key="index">
            ...
            <div class="item_center">
              ...
              <div class="item_right">
                ...
                <div class="right_content">
                  ...
                  <div>{{item.isToHospital == true ? '已到院' : '未到院'}}</div>
                  <!-- <div>
                ...
                <div class="hospital_con">派单医院：<div class="hospital">{{item.sendHospital}}</div></div>
              </div>
            </div>
          ...
          <template #right>
            <van-button square color="linear-gradient(to bottom, #8ab4fe,#5492FE)" text="确认" @click="affirm(item)"/>
...
export default {
  ...
  methods: {
    ...
    affirm(value){
      ...
      this.$router.push({path:'/deal',query:{consultatioType:value.consultatioType,orderId:value.orderId}})
    },
